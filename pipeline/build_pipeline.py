...
def main():
    try:
        ...
        loader=DataLoader("/home/user/Documents/movie_recommander/data/action.csv",'/home/user/Documents/movie_recommander/data/action_updated.csv')
        processed_csv = loader.loader_process()
